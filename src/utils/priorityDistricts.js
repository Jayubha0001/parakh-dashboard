// The 10 priority districts the state is focusing extra attention on.
// Spelling matches the canonical district names used throughout this app
// (Dashboard_PARAKH / Combined_Performance_Ranking), which differ
// slightly from the ALL-CAPS PM-SHRI sheet in a couple of cases:
// "KACHCHH" -> "Kutch" and "DOHAD" -> "Dahod" are the same district
